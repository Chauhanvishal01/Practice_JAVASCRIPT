...
// Print all the elements of an array using a for loop.

const superhero = ["Hanuman ji", "thor", "spiderman", "ironman"];
...
let fibbArr = [numone, numtwo];

for (let i = 2; i < 10; i++) {
  let Nextsum = numone + numtwo;
  fibbArr.push(Nextsum);
  numone = numtwo;
  numtwo = Nextsum;
}
